# -*- coding: utf-8 -*-
"""
Created on Tue Jul 14 12:08:10 2020
...
def renko_DF(DF):
    ...
    #this counts the run of up/down trends
...
for ticker in tickers:
    ohlc_intraday[ticker] = yf.download(ticker,dt.date.today()-dt.timedelta(59),dt.datetime.today(), interval='30m') 
    
# this is going to remove the time-zone stamp. 
# the merge that happens in the first backtesting loop wont work without this   
for ticker in tickers:    
    ohlc_intraday[ticker]=ohlc_intraday[ticker].tz_localize(None)
...
for ticker in tickers:
    ...
    #this outer merge will form NaN, so we forward fill the number of Renko Bars
