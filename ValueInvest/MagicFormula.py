# -*- coding: utf-8 -*-
"""
Created on Thu Jul 16 10:39:55 2020
...
tickers = ["AN", "BYD", "TPX", "EAT", "STE",  "SYNH", "HAE", "PBH", "MSA", "RBC", "AVT", "FICO", "CUZ", "SKT"]
...
#we need to check this frequently because even if it runs, the components of the
#tables can shift around
#this does NOT USE TTM, but previous year finance instead
for ticker in tickers:
    ...
    #getting balance sheet data from yahoo finance for the given ticker
        ...
        for t in tabl:
            rows = t.find_all("div", {"class" : "rw-expnded"})
            for row in rows:
                #column index 2 gives recent statement, instead of TTM
...
stats = ["EBITDA",
         ...
         "Long-term debt", 
         "Forward annual dividend yield"]# change to match Yahoo
...
# calculating relevant financial metrics for the magic formula
transpose_df = all_stats_df.T
...
#metric using magic + dividend yields
